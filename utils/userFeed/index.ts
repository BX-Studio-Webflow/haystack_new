...
export async function userFeedCode({ dataSource }: { dataSource: 'live' | 'dev' }) {
  ...
  if (lsInsights) {
    userFollowingAndFavourite &&
      initInsights(JSON.parse(lsInsights) as Insight, allTabsTarget, userFollowingAndFavourite);
  ...
  async function getInsights(
    endPoint: '/insight-all-tab' | '/insight-favourite-tab' | '/insight-following-tab',
    ...
    try {
      ...
      userFollowingAndFavourite && initInsights(insights, target, userFollowingAndFavourite);

      endPoint === '/insight-all-tab' && paginationLogic(insights, 'all');
      endPoint === '/insight-following-tab' && paginationLogic(insights, 'following');
      endPoint === '/insight-favourite-tab' && paginationLogic(insights, 'favourite');
  ...
  function paginationLogic(insight: Insight, target: 'all' | 'following' | 'favourite') {
    let endPoint: '/insight-all-tab' | '/insight-following-tab' | '/insight-favourite-tab';
